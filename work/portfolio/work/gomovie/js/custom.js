...
$(window).resize(function(){
  ...
  if(winWid<=600){
    $('.slider .ss3').css({"background": "url(../img/banner1-3.png)", "background-position": "center center"})
    ...
    $('.slider .ss3').css({"background": "url(../img/friend1.png)", "background-position": "center center","background-size": "cover"})
  }
