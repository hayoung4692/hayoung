...
$(window).resize(function(){
  ...
  if(winWid<=600){
    $('.slider .ss3').css({"background": "url(../img/gangreng2.png)", "background-position": "center center"})
    ...
    $('.slider .ss3').css({"background": "url(../img/gangreng.png)", "background-position": "center center","background-size": "cover"})
  }
